...
**
** Created: Sat Jun 23 21:14:31 2012
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        padraoTextBox = new QLineEdit(widget);
        ...
        padraoAreaTextBox = new QLineEdit(widget);
        ...
        padraoBGTextBox = new QLineEdit(widget);
        ...
        padraoBGAreaTextBox = new QLineEdit(widget);
        ...
        padraoTempoTextBox = new QLineEdit(widget);
        ...
        widget1->setGeometry(QRect(230, 10, 241, 121));
        ...
        padraoSeringaCheiaTextBox = new QLineEdit(widget1);
        ...
        padraoSeringaVaziaTextBox = new QLineEdit(widget1);
        ...
        pacienteSeringaCheiaTextBox = new QLineEdit(widget1);
        ...
        pacienteSeringaVaziaTextBox = new QLineEdit(widget1);
        ...
        widget2->setGeometry(QRect(490, 10, 171, 101));
        ...
        widget3->setGeometry(QRect(80, 180, 251, 151));
        formLayout_3 = new QFormLayout(widget3);
        ...
        rimEsquerdoTextBox = new QLineEdit(widget3);
        ...
        rimEsquerdoAreaTextBox = new QLineEdit(widget3);
        ...
        rimEsquerdoBGTextBox = new QLineEdit(widget3);
        ...
        rimEsquerdoBGAreaTextBox = new QLineEdit(widget3);
        ...
        rimEsquerdoTempoTextBox = new QLineEdit(widget3);
        ...
        widget4->setGeometry(QRect(360, 180, 231, 151));
        ...
        rimDireitoTextBox = new QLineEdit(widget4);
        ...
        rimDireitoAreaTextBox = new QLineEdit(widget4);
        ...
        rimDireitoBGTextBox = new QLineEdit(widget4);
        ...
        rimDireitoBGAreaTextBox = new QLineEdit(widget4);
        ...
        rimDireitoTempoTextBox = new QLineEdit(widget4);
